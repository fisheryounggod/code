...
prog define cuselist
	...
	di "3. {stata cuse jd141516cjd, c w s: jd141516cjd.dta}: 暨南大学2014——2016级学生成绩单"
	di "4. {stata cuse jd14151617xxb, c w s: jd14151617xxb.dta}: 暨南大学2014——2016级学生信息表"
	di "5. {stata cuse jd14151617tsg2017.dta, c w s: jd14151617tsg2017.dta}: 暨南大学2014-2017级学生2017年图书馆数据集"
	di "--------------------------------------------------"
	di "【l】"
	di "--------------------------------------------------"
	...
	di "4. {stata cuse pjw, c w s: pjw.dta}: 分城市人口、就业与工资(1990-2016)"
	di "--------------------------------------------------"
	di "【s】"
	di "--------------------------------------------------"
	...
	di "2. {stata cuse tourism, c w s: tourism.dta}: 旅游事业发展情况"
